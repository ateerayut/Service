...
ตั้งค่า Connection String และ JWT Key ผ่าน **User Secrets** (เพื่อความปลอดภัย ไม่เก็บในไฟล์ config):

```powershell
# ไปที่โฟลเดอร์ API
cd src/Service.Api

# ตั้งค่า Database (เปลี่ยน password เป็นของคุณ)
...
# ตั้งค่า JWT Secret (ต้องมีความยาวอย่างน้อย 32 ตัวอักษร)
...
- **API UI**: [http://localhost:8080/scalar/v1](http://localhost:8080/scalar/v1) (สำหรับลองเล่น API)
